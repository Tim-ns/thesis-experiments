...
export INSTANCE_DIR="${DATA_ROOT}/dataset/dog"
export CLASS_DIR="${DATA_ROOT}/classes/class_dog"
export OUTPUT_DIR="${EXP_ROOT}/dreambooth/results/training/dog_lora_encoder"
...
mkdir -p logs/training/dog
LOG_FILE="logs/training/dog/train_$(date +%Y%m%d_%H%M%S).log"
