...
export INSTANCE_DIR="${DATA_ROOT}/dataset/backpack"
export CLASS_DIR="${DATA_ROOT}/classes/class_backpack"
export OUTPUT_DIR="${EXP_ROOT}/dreambooth/results/training/backpack_lora_encoder"
...
mkdir -p logs/training/backpack
LOG_FILE="logs/training/backpack/train_$(date +%Y%m%d_%H%M%S).log"
